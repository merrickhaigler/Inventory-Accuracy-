...
function getCircleColor(OH, RFID){
  if(OH < 0){
    color =  "#0A51F6"; // negative OH fully understated (blue)
  }
    ...
    color =  "#0A51F6";  // frozen out of stock (blue)
  }
...
function stockedPercent(OH_array,RFID_array){
  percent = calculateOutofStock(OH_array,RFID_array) / calculateStocked(OH_array, RFID_array)
